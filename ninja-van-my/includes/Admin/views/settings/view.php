...
<div class="wrap">
    ...
    <form id="ninja_van_form_submit" action="" method="POST">
                        ...
                        <td>
                            ...
                            <div class="text-center">
                                <p class="text-info">
                                    <?php
                                    echo wp_kses(
                                        __('Webhook URL for <strong>Pending Pickup</strong>, <strong>Picked Up</strong>, <strong>Arrived at Transit Hub</strong>, <strong>On Vehicle For Delivery</strong>, <strong>Cancelled</strong>, <strong>Returned To Sender</strong>, and <strong>Delivered</strong> Events.', 'ninja-van-my'),
                                        array('strong' => array())
                                    );
                                    ?>
                                </p>
        ...
        <!-- Debug -->
        <div class="ninja_van_form ninja_van_form_mw" id="form-debug" style="<?php echo (Ninja_Van_MY_DEVELOPMENT ? '' : 'display:none;'); ?>">
            <table class="form-table">
                <tbody>
                    <tr>
                        <td colspan="2" class="text-title" style="text-decoration:none">
                    ...
                    <tr>
                        <th colspan="2" class="text-center">
                            <h3 class="text-title">
                                <?php esc_html_e('Debug Information', 'ninja-van-my'); ?>
                            </h3>
                        </th>
                    </tr>
                </tbody>
            ...
            <?php if (Ninja_Van_MY_DEVELOPMENT): ?>
                <?php 
                $debug_data = nv_my_info();
                $sections = [
                    'system' => __('System Information', 'ninja-van-my'),
                    'settings' => __('Settings Information', 'ninja-van-my'),
                    'config' => __('Configuration Information', 'ninja-van-my'),
                    'cron' => __('Cron Information', 'ninja-van-my'),
                    'tables' => __('Database Information', 'ninja-van-my'),
                ];
                ?>
                <?php foreach($sections as $section_key => $section_title): ?>
                    <?php if (isset($debug_data['data'][$section_key])): ?>
                        <h4><?php echo esc_html($section_title); ?></h4>
                        <table class="wp-list-table widefat fixed">
                            <thead>
                                <tr>
                                    <th width="30%"><?php esc_html_e('Key', 'ninja-van-my'); ?></th>
                                    <th><?php esc_html_e('Value', 'ninja-van-my'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                $section_data = $debug_data['data'][$section_key];
                ...
                <div class="ninja_van_footer">
                    <div class="ninja_van_footer_text">
                        <p class="text-info"><?php esc_html_e('This debug information is only visible when DEVELOPMENT mode is enabled.', 'ninja-van-my'); ?></p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
