    ...
    class Settings
    {
        ...
        static public function nv_settings_form_handlers(): void{
            ...
            $settings = [
                ...
                'plugin_old_auth_mode' => (isset($_POST['auth_mode_static'])) ? sanitize_text_field( $_POST['auth_mode_static'] ) : NULL,
        ...
        private static function nv_settings_save($form): void{
            ...
            $previous_auth_mode = isset($plugin_old_auth_mode) ? $plugin_old_auth_mode : Ninja_Van_MY_OAUTH;
            $auth_mode = isset($plugin_auth_mode) ? 'PLUGIN' : $previous_auth_mode;
        ...
        static public function nv_download_awb(): void{
            ...
            if (is_user_logged_in() && is_admin() && isset($_REQUEST['download_awb'])) {
                $download_awb = sanitize_text_field($_REQUEST['download_awb']);
                if (is_numeric($download_awb)) {
