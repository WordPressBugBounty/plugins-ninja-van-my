<?php
    ...
    class WooCommerceOption
    {
        ...
        public function register_ninja_van_order_status() {
            ...
            register_post_status( 'wc-nv-picked-up', array(
                'label'                     => 'NV Picked Up',
                'public'                    => true,
                'exclude_from_search'       => false,
                'show_in_admin_all_list'    => true,
                'show_in_admin_status_list' => true,
                'label_count'               => _n_noop( 'NV Picked Up (%s)', 'NV Picked Up (%s)', 'ninja-van-my' )
            ) );
        ...
        public function register_ninja_van_order_statuses( $order_statuses ) {
            ...
            foreach ( $order_statuses as $key => $status ) {
                ...
                if ( 'wc-processing' === $key ) {
                    ...
                    $new_order_statuses['wc-nv-picked-up'] = 'NV Picked Up';
