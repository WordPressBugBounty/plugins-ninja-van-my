...
= 1.1.5 =
### What's New
* Added 'Picked Up' status for WooCommerce
...
= 1.1.7 =
### Changes
* Added `battery_present` and `liquid_present` fields to customs declaration for international orders (API 4.2 compliance)
